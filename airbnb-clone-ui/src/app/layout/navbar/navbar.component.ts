...
import { PropertiesCreateComponent } from '../../pages/landlord/properties-create/properties-create.component';
import { SearchComponent } from '../../pages/tenant/search/search.component';
